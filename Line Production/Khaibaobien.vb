...
Module Khaibaobien
    ...
    Public PathLogWipSetup As String = ""
    Public PathStatus As String = ""
    Public setfilenamereport As String = ".txt"
    Public CountFileBeginDay As Integer
    Public CountFileBeginNight As Integer
    Public CountFileCurrentDay As Integer
    Public CountFileCurrentNight As Integer
    ...
    Public CycleTimeActual As Integer = 0
    ...
    Public TimeLine(21) As DateTime ' bien quy dinh khung gio 
    Public TimePauseLine As Integer ' bien ghi gio tam dung line
    Public CountProduct As Integer = 0 ' dem san luong cua line model
    Public CountProductPerHour(21) As Integer ' dem san luong cua tung gio
    ...
    Public TimeCycleActual As Integer = 0 ' bien dem thoi gian cycle time thuc te ma line dang chay
    ...
    Public ArraySend As String = "00000000000000B"
    '///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Public Function LoadModelCurrent(ByVal ModelLoad As String) As Boolean
        ...
        If Strcheck.Length <> 0 Then
            ...
            If File.Exists(PathModelCurrent) = True Then
                ...
                PathLogWipSetup = ReadTextFile(PathModelCurrent, 18)
                setfilenamereport = ReadTextFile(PathModelCurrent, 20)
                If BarcodeEnable = 1 Then
