...
Module Module1
    ...
    Function CounterlineTextFile(ByVal File_Path As String) As Integer   ' nhap duong dan file va dong can doc
        ...
        Return counterLine
    End Function
    Public Sub ReplaceLine(ByVal filePath As String, ByVal LineNumber As Integer, ByVal NewLine As String)
        ...
        Using file As New StreamReader(filePath)
            ...
            For i As Integer = 0 To lines.Length - 1
                If i = LineNumber - 1 Then
                    lines(i) = NewLine
                End If
                Databin = Databin & lines(i) & Chr(13) & Chr(10)
            Next
        End Using
        IO.File.Delete(filePath)
        IO.File.WriteAllText(filePath, Databin)
    End Sub
